...
describe('App', () => {
  ...
  describe('Conditional rendering', () => {
    // TODO: Step 12
    it("hides the `Add Task` button when 'Add Task' is clicked", async () => {
    ...
    // TODO: Step 13
    it("opens the TaskModal when 'Add Task' is clicked", async () => {
      await userEvent.click(screen.getByText('Add Task'))
    ...
    // TODO: Step 14
    it('closes the modal and reveals the `Add Task` button when task is submitted', async () => {
      await userEvent.click(screen.getByText('Add Task'))
